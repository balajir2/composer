...
**Status.** Accepted 2026-07-13. User approved: Cloud Tasks as new infrastructure, full replacement of the in-process execution model (not run-alongside), and P1-2 + P1-4 implemented together. Implementation plan: `docs/superpowers/plans/2026-07-13-durable-execution-cloud-tasks.md` (16 tasks, TDD). Tasks 1-5 implemented and reviewed as of 2026-07-14 (schema migration, Cloud Tasks config settings, Postgres rate limiter, persisted execution events); Tasks 6-16 in progress. See 2026-07-14 addendum below for a cost-driven refinement to Task 11/14's scope, made mid-implementation.
