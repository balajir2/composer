...
| 1 — Execution engine core | ⏭ Next | LangGraph Python executor, Start+End nodes, Postgres checkpointer, real Prisma schema |
| 2 — Agent + LLM providers | ⏸ | LangChain: Anthropic, OpenAI, Google, Groq |
